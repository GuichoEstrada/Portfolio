...
const HireMe = () => {
  return (
    <div className='absolute left-4 bottom-4 flex items-center justify-center overflow-hidden'>
        <div className='w-48 h-auto flex justify-center relative'>
            <CircularText className={"fill-dark animate-spin-slow dark:fill-light"} />
            <Link 
                href="mailto:lcrestrada.dev@gmail.com" 
                ...
                w-20 h-20 rounded-full font-semibold hover:bg-light hover:text-dark dark:text-dark
